...
class CldCustUploadLgRestApi extends Component {
    processFile = async (e) => {
        ...
        var YOUR_CLOUD_NAME = 'cgv-golf';
        var YOUR_UNSIGNED_UPLOAD_PRESET = 'hdvpsezy';
    ...
    render() {
        return (
            <div>
                <h3>Upload:</h3>
                <p>
                    Note: Before choosing a file, set your cloud name and
                    unsigned upload preset in CldCustUploadLgRestApi.js:
                </p>
                <p>YOUR_CLOUD_NAME</p>
